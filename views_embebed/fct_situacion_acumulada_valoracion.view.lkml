view: fct_situacion_acumulada_valoracion_embebed {
  sql_table_name: `bm-gcp-p1-dw.looker_embebed.fct_situacion_acumulada_valoracion`
    ;;
  ...
  filter: sin_cargo_por_incobrabilidad {
    ...
    sql: ${lkp_conceptos_valoracion_agrupaciones_embebed.concepto_valoracion_agrupacion_1} not in ("Cargos Por Incobrabilidad", "Cargos por Incobrabilidad") ;;
  }
  ...
  measure: pnb_filtrado {
    ...
    type: sum
    value_format_name: decimal_0
    filters: [lkp_conceptos_valoracion_agrupaciones_embebed.concepto_valoracion_agrupacion_1: "-Cargos Por Incobrabilidad, -Cargos por Incobrabilidad"]
    sql: ${valor_propio_mes} ;;
  }
