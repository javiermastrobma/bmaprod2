view: fct_situaciones_comex {
  sql_table_name: `bm-gcp-p1-dw.cdw_raw.fct_situaciones_comex`
    ;;
    view_label: " Fct Situaciones Comex"

  dimension: fecha_max {
    hidden: yes
    type: yesno
    sql:  ${fecha_key} = (SELECT MAX(f.fecha_key) FROM fct_situaciones_comex s
  ...
  dimension: interes_devengado_promedio {
    type: number
    sql: ${TABLE}.interes_devengado_promedio ;;
  }
  ...
  dimension: interes_documentado_promedio {
    type: number
    sql: ${TABLE}.interes_documentado_promedio ;;
  }
  ...
  dimension: saldo_capital_promedio {
    type: number
    sql: ${TABLE}.saldo_capital_promedio ;;
  }
