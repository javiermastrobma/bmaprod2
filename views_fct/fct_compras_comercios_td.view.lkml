view: fct_compras_comercios_td {
  sql_table_name: `bm-gcp-p1-dw.cdw_raw.fct_compras_comercios_td`
    ;;
    view_label: " Fct Compras Comercios TD"

dimension: fecha_max {
    hidden: yes
    type: yesno
    sql:  ${fecha_key} = (SELECT MAX(f.fecha_key) FROM fct_compras_comercios_td s
