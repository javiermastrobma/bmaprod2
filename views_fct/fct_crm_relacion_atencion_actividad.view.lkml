view: fct_crm_relacion_atencion_actividad {
  sql_table_name: `bm-gcp-p1-dw.cdw_raw.fct_crm_relacion_atencion_actividad`
    ;;
    view_label: " Fct CRM Relación Atención Actividad"

  dimension: fecha_max {
    hidden: yes
    type: yesno
    sql:  ${fecha_alta_key} = (SELECT MAX(f.fecha_key) FROM fct_crm_relacion_atencion_actividad s
