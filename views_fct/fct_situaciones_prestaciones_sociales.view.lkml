view: fct_situaciones_prestaciones_sociales {
  sql_table_name: `bm-gcp-p1-dw.cdw_raw.fct_situaciones_prestaciones_sociales`
    ;;
    view_label: " Fct Situaciones Prestaciones Sociales"

  dimension: fecha_max {
    hidden: yes
    type: yesno
    sql:  ${fecha_key} = (SELECT MAX(f.fecha_key) FROM fct_situaciones_prestaciones_sociales s
